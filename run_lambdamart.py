...
training_queries = Queries.load_from_text('./MSLR-WEB10K/Fold1/train.txt')
validation_queries = Queries.load_from_text('./MSLR-WEB10K/Fold1/vali.txt')
test_queries = Queries.load_from_text('./MSLR-WEB10K/Fold1/test.txt')

logging.info('================================================================================')

# Save them to binary format ...
training_queries.save('./rankpy_data/training')
validation_queries.save('./rankpy_data/validation')
test_queries.save('./rankpy_data/test')

# ... because loading them will be then faster.
training_queries = Queries.load('./rankpy_data/training')
validation_queries = Queries.load('./rankpy_data/validation')
test_queries = Queries.load('./rankpy_data/test')
